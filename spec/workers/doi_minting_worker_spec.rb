...
describe DoiMintingWorker do
  ...
  let(:attributes){ {pid: "#{Sufia.config.id_namespace}:3t94g081v", publisher: 'An Interesting Chap!', date_uploaded: Date.parse('2013-01-30'), date_modified: Date.parse('2013-01-30'), title: "A Title", creator: 'The Creator'} }
  ...
  context 'mint doi' do
    it "should mint!", VCR::SpecSupport(cassette_name: "remotely_identified_doi_mint_generic_work") do
      ...
      expect{
        DoiMintingWorker.new(generic_work.pid).run
