...
describe 'error behavior', describe_options do
  it 'handles missing route with 404' do
    ...
    expect(page).to have_content(I18n.t('exception.show.not_found.title'))
  end
  ...
  it 'handles unauthorized pages'do
    ...
    expect(page).to have_content(I18n.t('exception.show.unauthorized.title'))
    expect(page).to have_content(I18n.t('exception.show.unauthorized.description'))
  end
end